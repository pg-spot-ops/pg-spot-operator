...
if __name__ == "__main__":
    ...
    shared_buffers_mb = int(max(int(ram_mb * 0.20), 128))
    ...
    o["max_connections"] = max(100, min(cpus * 50, 500))
    work_mem = int((ram_mb - shared_buffers_mb) / o["max_connections"] / 2)  # 2 is default parallelism
    if work_mem > 4:
